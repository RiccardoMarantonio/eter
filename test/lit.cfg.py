...
config.test_exec_root = os.path.join(config.quar_obj_root, "test")

config.substitutions.append(("%quar", '"{}"'.format(config.quar_executable)))
...
config.environment["PATH"] = os.pathsep.join(
    [
        os.path.dirname(config.quar_executable),
